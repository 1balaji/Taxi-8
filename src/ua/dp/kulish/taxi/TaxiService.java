...
public class TaxiService extends TabActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		TabSpec tabFavorits;
		View viewTabFavorits = getLayoutInflater().inflate(
				R.layout.tab_favorite, null);
		...
		TabSpec tabOrder;
		View viewTabOrder = getLayoutInflater().inflate(R.layout.tab_order,
				null);
	...
	/*
	 * private TabSpec myTabSpec(String name, Class activity) { TabSpec tabSpec;
	 * View viewTabHeader = getLayoutInflater().inflate(R.layout.tab_header,
	 * null); tabSpec = tabHost.newTabSpec(name);
	 * tabSpec.setIndicator(viewTabHeader); Intent intent = new Intent(this,
	 * activity.class); tabSpec.setContent(intent); return tabSpec;
	 * 
	 * }
	 */
